...
ct.inputs.addAction('Stop', [{"code":"keyboard.Space"},{"code":"mouse.Left"},{"code":"touch.Any"}]);
...
ct.rooms.templates['Main-Game-Room'] = {
    ...
    width: 1000,
    height: 600,
    objects: [{"x":192,"y":256,"type":"Player"}],
    bgs: [{"depth":-5,"texture":"Floor","extends":{"shiftY":0,"shiftX":0,"movementX":0.2}}],
    ...
    if(this.est > 0){
        ...
        this.est = this.tttest
        ct.types.copy("Enemy",1000,ct.random.range(0,532))
        console.log("spaawn")
        this.tttest -= 1
        ct.sound.spawn("Spawn",{loop:false})
    }
}else{
    if(ct.actions.Stop.value){
        this.gameover = false
        ct.types.copy("Player",192,256)
        this.score = 0
    }
}
...
this.est = 120
this.tttest = 120
this.scoreStyle = ct.styles.get('Score', true);
this.gameover = false

this.scoreLabel = new PIXI.Text('Score: ' + this.score,this.scoreStyle);
...
(function (ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"enemy":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"Floor":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}},"player":{"frames":1,"shape":{"type":"rect","top":0,"bottom":64,"left":0,"right":64},"anchor":{"x":0,"y":0}}}][0],
...
if(this.x < 0){
    ct.room.score += ct.random.dice(100,100,100,500,300,300)
    this.kill = true
}
...
this.move();
    ...
    onDestroy: function () {
console.log("exp")
ct.sound.spawn("Coin",{loop:false,volume:0.2})
    },
    onCreate: function () {
console.log("new")
    },
...
ct.sound.init('Spawn', {
    wav: './snd/564339da-83f0-453b-af07-2a4d88d76e25.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('Exp', {
    wav: './snd/eb892a34-c236-4547-97d3-f4008b24f016.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('Coin', {
    wav: './snd/08bd0e12-faf6-4c0f-bbb6-2b72f2e895ff.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
